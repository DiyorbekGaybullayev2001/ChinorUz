...
const DownlaodPdf = () => {
  return (
    <div id='book' className="container m-auto grid grid-cols-1 md:grid-cols-2 items-center text-center p-[10px] pt-[100px]">
      <div id='' className="text-center w-[100%] m-auto ">
        {/* Title */}
        <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3  items-center gap-3 p-[10px]">
          ...
          />
          {/* Submit Button */}
          <div id='' className='w-full mt-[15px] m-auto text-center'>
      ...
      <div id='download' className='content-end flex justify-center w-full m-auto'>
