...
const Swipers = () => {
    return (
        <div id='works' className=" container m-auto pt-[100px] p-[10px]">
            <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 p-[10px]'>
                <div className='text-white bg-[#94C11F] p-[10px] m-[10px] rounded-lg'>
                    ...
                    <p className='text-[#e9e5e5] text-[13px] sm:text-[18px]'> Доставка по Ташкенту от 30.000 сум. Отправляем мебель в другие города Узбекистана, условия доставки обсуждается индивидуально. </p><br />
                    <p className='text-[#e9e5e5] text-[13px] sm:text-[18px]'>Доставка до клиента производиться нашими сотрудниками, которые также помогут поднять и собрать мебель</p>
                </div>

                <div className='text-white bg-[#94C11F] p-[10px] m-[10px] rounded-lg'>
                    <br />
                    <h2 className='text-[20px] md:text-[30px]'>Способы оплаты</h2><br />
                    <p className='text-[#e9e5e5] text-[13px] sm:text-[18px]'>Любая форма оплаты-безналичные, наличные и перечислением. </p><br />
                    <p className='text-[#e9e5e5] text-[13px] sm:text-[18px]'>Вы можете оплатить 100% стоимости товара или внести 10% от общей суммы, оставшуюся часть оплатить уже после осмотра и привоза мебели к вам домой</p>
                </div>
